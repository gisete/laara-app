...
const styles = StyleSheet.create({
	...
	dateCircleToday: { backgroundColor: colors.textPrimary },
	dateNum: { fontSize: 13, fontWeight: "600" },
	dateNumToday: { color: colors.surfaceDefault },
	dateNumStudied: { color: colors.textPrimary },
	dateNumNotStudied: { color: colors.textSecondary },
	dotContainer: { height: 8, alignItems: "center", justifyContent: "center", marginTop: 3 },
	studiedDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.accentPrimary },
});
